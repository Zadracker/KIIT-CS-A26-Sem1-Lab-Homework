...
Enter element for a[1x1]: 1
Enter element for a[1x2]: 2
Enter element for a[1x3]: 1
Enter element for a[2x1]: 2
Enter element for a[2x2]: 1
Enter element for a[2x3]: 2
Enter element for a[3x1]: 1
Enter element for a[3x2]: 2
Enter element for a[3x3]: 1
